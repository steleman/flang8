  ...
  for (auto &F : M) {
    if (F.isDeclaration() && !F.use_empty()) {
      ...
      case Intrinsic::exp10:
        EnsureFPIntrinsicsExist(M, F, "exp10f", "exp10", "exp10l");
        break;
      case Intrinsic::acos:
        EnsureFPIntrinsicsExist(M, F, "acosf", "acos", "acosl");
        break;
      case Intrinsic::asin:
        EnsureFPIntrinsicsExist(M, F, "asinf", "asin", "asinl");
        break;
      case Intrinsic::atan:
        EnsureFPIntrinsicsExist(M, F, "atanf", "atan", "atanl");
        break;
      case Intrinsic::atan2:
        EnsureFPIntrinsicsExist(M, F, "atan2f", "atan2", "atan2l");
        break;
      case Intrinsic::tan:
        EnsureFPIntrinsicsExist(M, F, "tanf", "tan", "tanl");
        break;
      case Intrinsic::cosh:
        EnsureFPIntrinsicsExist(M, F, "coshf", "cosh", "coshl");
        break;
      case Intrinsic::sinh:
        EnsureFPIntrinsicsExist(M, F, "sinhf", "sinh", "sinhl");
        break;
      case Intrinsic::tanh:
        EnsureFPIntrinsicsExist(M, F, "tanhf", "tanh", "tanhl");
        break;
      case Intrinsic::acosh:
        EnsureFPIntrinsicsExist(M, F, "acoshf", "acosh", "acoshl");
        break;
      case Intrinsic::asinh:
        EnsureFPIntrinsicsExist(M, F, "asinhf", "asinh", "asinhl");
        break;
      case Intrinsic::atanh:
        EnsureFPIntrinsicsExist(M, F, "atanhf", "atanh", "atanhl");
        break;
      case Intrinsic::lgamma:
        EnsureFPIntrinsicsExist(M, F, "lgammaf", "lgamma", "lgammal");
        break;
      case Intrinsic::tgamma:
        EnsureFPIntrinsicsExist(M, F, "tgammaf", "tgamma", "tgammal");
        break;
      }
    }
  }

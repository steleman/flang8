...
SDNode* SelectionDAG::mutateStrictFPToFP(SDNode *Node) {
  ...
  case ISD::STRICT_FACOS:   NewOpc = ISD::FACOS;   IsUnary = true; break;
  case ISD::STRICT_FASIN:   NewOpc = ISD::FASIN;   IsUnary = true; break;
  case ISD::STRICT_FATAN:   NewOpc = ISD::FATAN;   IsUnary = true; break;
  case ISD::STRICT_FTAN:    NewOpc = ISD::FTAN;    IsUnary = true; break;
  case ISD::STRICT_FCOSH:   NewOpc = ISD::FCOSH;   IsUnary = true; break;
  case ISD::STRICT_FSINH:   NewOpc = ISD::FSINH;   IsUnary = true; break;
  case ISD::STRICT_FTANH:   NewOpc = ISD::FTANH;   IsUnary = true; break;
  case ISD::STRICT_FASINH:  NewOpc = ISD::FASINH;  IsUnary = true; break;
  case ISD::STRICT_FACOSH:  NewOpc = ISD::FACOSH;  IsUnary = true; break;
  case ISD::STRICT_FATANH:  NewOpc = ISD::FATANH;  IsUnary = true; break;
  case ISD::STRICT_FLGAMMA: NewOpc = ISD::FLGAMMA; IsUnary = true; break;
  case ISD::STRICT_FTGAMMA: NewOpc = ISD::FTGAMMA; IsUnary = true; break;
  case ISD::STRICT_FEXP10:  NewOpc = ISD::FEXP10;  IsUnary = true; break;
  ...
  case ISD::STRICT_FNEARBYINT: NewOpc = ISD::FNEARBYINT; IsUnary = true; break;

...
void TargetLibraryInfoImpl::addVectorizableFunctionsFromVecLib(
  ...
  case SLEEF: {
    if (TT.getArch() == llvm::Triple::aarch64 ||
      ...
      const VecDesc AArch64TwoAndFourLaneVecFuncs[] = {
        ...
        { "llvm.acos.v2f64", "_ZGVnN2v_acos", 2 },
        { "llvm.acos.v4f32", "_ZGVnN4v_acosf", 4 },
        ...
        { "llvm.asin.v2f64", "_ZGVnN2v_asin", 2 },
        { "llvm.asin.v4f32", "_ZGVnN4v_asinf", 4 },
        ...
        { "llvm.cosh.v2f64", "_ZGVnN2v_cosh", 2 },
        { "llvm.cosh.v4f32", "_ZGVnN4v_coshf", 4 },
        ...
        { "llvm.log.v2f64", "_ZGVnN2v_log", 2 },
        { "llvm.log.v4f32", "_ZGVnN4v_logf", 4 },
        ...
        { "llvm.sinh.v2f64", "_ZGVnN2v_sinh", 2 },
        { "llvm.sinh.v4f32", "_ZGVnN4v_sinhf", 4 },
        ...
        { "llvm.sqrt.v2f64", "_ZGVnN2v_sqrt", 2 },
        { "llvm.sqrt.v4f32", "_ZGVnN4v_sqrtf", 4 },
        ...
        { "llvm.tan.v2f64", "_ZGVnN2v_tan", 2 },
        { "llvm.tan.v4f32", "_ZGVnN4v_tanf", 4 },
        ...
        { "llvm.tanh.v2f64", "_ZGVnN2v_tanh", 2 },
        { "llvm.tanh.v4f32", "_ZGVnN4v_tanhf", 4 },
      ...
      if (VF >= 128U) {
        if (UseFastMath && UseFiniteMathOnly)
          addVectorizableFunctions(AArch64TwoAndFourLaneVecFuncsFastMath);
        else if (UseFastMath && !UseFiniteMathOnly)
          addVectorizableFunctions(AArch64TwoAndFourLaneVecFuncsFastMath);
  ...
  case PGMATH: {
    const VecDesc X86_64PGIVecFuncs[] = {
    ...
    const VecDesc AArch64PGIVecFuncs[] = {
      {"__fd_sin_1", "__fd_sin_2", 2},
      {"__fd_sin_1", "__fd_sin_4", 4},
    ...
    if (TT.getArch() == llvm::Triple::aarch64)
      addVectorizableFunctions(AArch64PGIVecFuncs);
    else if (TT.getArch() == llvm::Triple::x86_64)
      addVectorizableFunctions(X86_64PGIVecFuncs);
    break;
  }
  case NoLibrary:
    break;

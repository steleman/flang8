...
void FlangFrontend::ConstructJob(Compilation &C, const JobAction &JA,
  ...
  if (Arg *A = Args.getLastArg(options::OPT_fsanitize_EQ)) {
    for (const StringRef &val : A->getValues()) {
      if (val.equals("discontiguous") || val.equals("undefined") ) {
        ...
        // passed on for further processing by the non-flang part of the
        // driver.
  ...
  */
  ...
  UpperCmdArgs.push_back("unix");
  UpperCmdArgs.push_back("-def");
  UpperCmdArgs.push_back("__unix");
  UpperCmdArgs.push_back("-def");
  UpperCmdArgs.push_back("__unix__");
  UpperCmdArgs.push_back("-def");
  UpperCmdArgs.push_back("linux");
  UpperCmdArgs.push_back("-def");
  UpperCmdArgs.push_back("__linux");
  UpperCmdArgs.push_back("-def");
  UpperCmdArgs.push_back("__linux__");
  UpperCmdArgs.push_back("-def");
  UpperCmdArgs.push_back("__NO_MATH_INLINES");
  UpperCmdArgs.push_back("-def");
  UpperCmdArgs.push_back("__LP64__");
  UpperCmdArgs.push_back("-def");
  UpperCmdArgs.push_back("__LONG_MAX__=9223372036854775807L");
  UpperCmdArgs.push_back("-def");
  UpperCmdArgs.push_back("__SIZE_TYPE__=unsigned long int");
  UpperCmdArgs.push_back("-def");
  UpperCmdArgs.push_back("__PTRDIFF_TYPE__=long int");

  switch (getToolChain().getEffectiveTriple().getArch()) {
  case llvm::Triple::aarch64:
    UpperCmdArgs.push_back("-def");
    UpperCmdArgs.push_back("__aarch64");
    UpperCmdArgs.push_back("-def");
    UpperCmdArgs.push_back("__aarch64__");
    UpperCmdArgs.push_back("-def");
    UpperCmdArgs.push_back("__ARM_ARCH=8");
    UpperCmdArgs.push_back("-def");
    UpperCmdArgs.push_back("__ARM_ARCH__=8");
    break;
  case llvm::Triple::x86_64:
    UpperCmdArgs.push_back("-def");
    UpperCmdArgs.push_back("__x86_64");
    UpperCmdArgs.push_back("-def");
    UpperCmdArgs.push_back("__x86_64__");
    UpperCmdArgs.push_back("-def");
